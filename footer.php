    ...
    <div class="footer2" style="width: 100%">
        <div class="bgimg2">
            <div style="background-color: rgba(8, 8, 8, 1);">
                <div class="footer1" style="text-align:center; background-image: linear-gradient(gray, white);">
                    <ul id="horizontal-list">
                        <li style="padding-top: 2px;">
                            <a href="https://www.facebook.com/ShivomSecuranation/" target="_blank">
                                <img src="childs_image/fb.png" class="socialimg ">
                            </a>
                        </li>
                        <li style="padding-top: 2px;">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/in/shivomsecuranation" target="_blank">
                                <img src="childs_image/linked%20in.png" class="socialimg ">
                            </a>
                        </li>
                        <li style="padding-top: 7px">
                            <a href="https://plus.google.com/u/0/114200475602279359366
                                        " target="_blank">
                    ...
                    <div class="col-12 d-flex flex-wrap justify-content-around">
                        <div class="footer-col col-12 col-lg-3 col-xl-3 col-md-3 col-sm-3">
                            <div class="rounded mb-2 p-2 d-flex flex-column justify-content-center"
                                ...
                                <div class="logo-container">
                                    <img src="childs_image/SHIVOM BUILDCON.png" alt="Logo 1" class="logo" id="logo1">
                                    <img src="childs_image/SHIVOM SECURANATION (1).png" alt="Logo 2" class="logo" id="logo2">
                                    <img src="childs_image/SHIVOM DREAM EARTH (1).png" alt="Logo 3" class="logo" id="logo3">
                                </div>

                                <a href="index.php">
                                    <h1 class="shree-logo"><span class="shivom">SHIVOM </span> 
                                    <span style="color: white;">GROUP</span></h1>
                                </h1>
                                </a>
                                <div>
                        ...
                        <div class="footer-col col-12 col-lg-3 col-xl-3 col-md-3 col-sm-3">
                            ...
                            <div class="footer-item">
                                ...
                                <p><a href="Product.php#ref2" class="footer-sub-link">S-TRAX Mobile Application</a></p>
                            </div>
                            <div class="footer-item">
                                <img src="childs_image/footer%20strax%20icon3.png" class="footer-icon">
                                <p><a href="Product.php#ref3" class="footer-sub-link">Digital Management System</a></p>
                            </div>
                        </div>
                        <div class="footer-col col-12 col-lg-3 col-xl-3 col-md-3 col-sm-3">
                            <p class="footer-title"><a href="Service.php" class="footer-link">SERVICES</a></p>
                            <p><a href="Service.php#ref1" class="footer-sub-link">Child And Women Safety System</a></p>
                            <p><a href="Service.php#ref2" class="footer-sub-link">School Student Tracking System</a></p>
